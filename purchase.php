     ...
     <div class="container">
        ...
        <div class="row pt-4 pb-10">
            <div class="col-lg-6 offset-lg-1 col-md-6 pb-5">
                <h1 class="ttl grn-txt pb-3 mb-0 fnt-s">Request Study Quotation</h1>
                ...
                <form class="request-form mt-5" novalidate method="POST" action="<?php echo SITEPATH;?>form-action.php">
                    ...
                    <input type="hidden" name="form_type" id="form_type" value="Request for Price">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                          ...
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                                <p class="text-dark"><strong>1500+</strong> Research Reports</p>
                            </div>
                            <div class="carousel-item">
                              <p class="text-dark">Serving <strong>
