...
if(isset($_GET['slug']))
{
    ...
    $report_popular_detail_all=$obj_report->getReportDetails($fields_popular_report,$condition_popular_report,$orderby_popular_report,6,0);
        ...
        <div class="row pt-4 pb-4 align-items-center">
            <div class="col-md-1">
                <a class="" href="<?php echo SITEPATH;?>" >
                     <img src="<?php echo SITEPATH;?>images/white-logo.png" alt="Towards Packaging" title="Towards Packaging" class="img-fluid company-logo" width="141" height="41">
                </a>     
            </div>
            <div class="col-md-6">
            ...
            ?>         
                    ...
                    <!--    <img src="<?php echo SITEPATH;?>images/home-page/Right-arrow-button.png" alt="next-arrow" class="img-fluid nxt-arrow" width="15" height="15">-->
                    <!--</a>-->
                   <a href="<?php echo SITEPATH;?>get-an-annual-membership" class="btn green-btn mt-0" target="_blank">Annual Membership <img src="<?php echo SITEPATH;?>images/home-page/Right-arrow-button.png" alt="next-arrow" class="img-fluid nxt-arrow" width="15" height="15">
                    </a>
                 </div>
            </div>
        </div>
         ...
         <div class="row align-items-center">
             <div class="col-md-7">
                 ...
                 <div class="banner-btn">
                    ...
                    2 How soon do you want to purchase the project%3F %0D%0A
                    Ans: %0D%0A
                    3 Do you have any budget in your mind for the project%3F %0D%0A
                    Ans: %0D%0A %0D%0A
                    We look forward to hearing from you. %0D%0A %0D%0A %0D%0A %0D%0A
                    Regards, %0D%0A
                    " class="btn green-btn">Ask to Expert
                        <img src="<?php echo SITEPATH;?>images/home-page/Right-arrow-button.png" alt="next-arrow" class="img-fluid nxt-arrow" width="15" height="15">
                    </a>
                 </div>
             </div>
 ...
 <div class="container">
     <div class="row ptb">
         ...
         <div class="col-md-4">
             ...
             <!--</div>-->
             <div class="bg-gray p-4 sticky-holder popular-data">
