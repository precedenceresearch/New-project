     ...
     <div class="container">
        ...
        <div class="row pt-4 pb-10">
            <div class="col-lg-6 offset-lg-1 col-md-6 pb-5">
                <h1 class="ttl pb-3 mb-0 fnt-s">Download Brochure</h1>
                ...
                <form class="request-form mt-5" novalidate method="POST" action="<?php echo SITEPATH;?>form-action.php">
                    ...
                    <div class="form-group row" style="">
                        <div>
                            <input type="radio" id="option1" name="requirement_type" value="I am interested in purchasing this report." required>
                            <label for="option1" style="padding-top: 20px; margin-bottom: 5px;">I am interested in purchasing this report.</label>
                        </div>
                        <div>
                            <input type="radio" id="option2" name="requirement_type" value="Provide me with details on the scope of the research.">
                            <label for="option2" style="margin-bottom: 5px;">Provide me with details on the scope of the research.</label>
                        </div>
                        <div>
                            <input type="radio" id="option3" name="requirement_type" value="I have a few customized queries regarding this report.">
                            <label for="option3" style="padding-bottom: 20px; margin-bottom: 5px;">I have a few customized queries regarding this report.</label>
                        </div>
                    </div>
                     
                     
                    <div class="form-group">
                        <label>Please share your requirement so we can get back to you with a solution<span class="text-danger">*</span></label>
                    ...
                    <div class="text-center pt-2">
                            <button type="submit" class="btn grn-btn">Submit</button>
                    </div>
                </form>
            </div>
            <div class="col-lg-5 col-md-6">
                <div class="space-left ">
                    ...
                    <div class="outer-main bg-dark-blue w-75">
                        <a href="tel:+1 804 441 9344" class="text-dark">
                            <img src="<?php echo SITEPATH;?>images/call-icon.webp" alt="call" class="img-fluid activity-icon">
                            +1 804 441 9344
                        </a>
                        <a href="tel:+44 7782 560 738" class="text-dark">
                            <img src="<?php echo SITEPATH;?>images/call-icon.webp" alt="call" class="img-fluid activity-icon">
                           +44 7782 560 738
                        </a>
                        <a href="mailto:<?php echo SITEEMAIL; ?>" class="text-dark">
                    ...
                    <div class="bg-dark-blue2 w-75 cust-slider">
